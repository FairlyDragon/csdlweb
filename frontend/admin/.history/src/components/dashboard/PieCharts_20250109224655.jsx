...
import { MoreVert, Download, PictureAsPdf } from "@mui/icons-material";
    ...
    >
      ...
      >
        ...
        <Box sx={{ display: "flex", gap: 1 }}>
          <FormControlLabel
            control={<Checkbox checked={showChart} onChange={handleChartChange} />}
            label="Chart"
          />
          <FormControlLabel
            control={<Checkbox checked={showValue} onChange={handleValueChange} />}
            label="Show Value"
          />
          <Button
            variant="outlined"
