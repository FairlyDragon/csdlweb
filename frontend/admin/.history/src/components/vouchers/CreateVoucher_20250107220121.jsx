...
const CreateVoucher = ({ onAddVoucher }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const newVoucher = {
      ...
      discount_percentage: formData.discountType === 'percentage' ? Number(formData.discountValue) : null,
      discount_amount: formData.discountType === 'amount' ? Number(formData.discountValue) : null,
