...
import { differenceInHours,differenceInSeconds, format, addDays } from "date-fns";
...
const VoucherAvailable = ({ vouchers }) => {
  ...
  const shouldShowFlashSale = (endDate) => {
    ...
    const oneDayBefore = addDays(end, -1); // 24 giờ trước khi kết thúc
    return now >= oneDayBefore && now < end;
  };
                ...
                >
                  ...
                  >
                    <Stack direction="row" spacing={1} alignItems="center">
                      <ElectricBoltIcon sx={{ color: "#000", fontSize: 18 }} />
