...
const menuItems = [
  ...
  { icon: AssessmentIcon, label: "Report", path: "/reports" },
  { icon: SettingsIcon, label: "Settings", path: "/settings" },
  { icon: LocalShippingIcon, label: "Delivery", path: "/delivery" },
  { icon: AdminPanelSettingsOutlinedIcon,label: "Sub Admins", path: "/admin" },
];
