...
export default function Food() {
  ...
  const handleEditProduct = (editedProduct) => {
    console.log("Original product:", editedProduct); // Debug log

    if (!editedProduct.menuitem_id) {
      console.error("Cannot edit: menuitem_id is missing");
      return;
    }

    foodService
      .updateFood(editedProduct.menuitem_id, editedProduct)
      .then((response) => {
