  ...
  const DayEventItem = ({ event }) => (
    <Paper
      sx={{
        ...
        left: '4px',
        right: '4px',
        top: `${event.start.getHours() * 48 + (event.start.getMinutes() / 60) * 48 + 80}px`,
        height: `${((event.end.getHours() - event.start.getHours()) * 48) + 
                 ((event.end.getMinutes() - event.start.getMinutes()) / 60) * 48}px`,
        bgcolor: event.color,
        color: 'white',
        p: 1,
        borderRadius: '4px',
