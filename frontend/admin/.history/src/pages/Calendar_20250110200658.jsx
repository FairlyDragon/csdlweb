...
const Calendar = () => {
  ...
  const EventForm = () => {
    // Khởi tạo formData với thời gian mặc định hợp lệ
    const [formData, setFormData] = useState({
      title: "",
      description: "",
      start: new Date(), // Thời gian hiện tại
      end: new Date(new Date().setHours(new Date().getHours() + 1)), // Thời gian hiện tại + 1 giờ
      color: "#1a73e8",
    });

    useEffect(() => {
      // Đảm bảo newEvent có giá trị hợp lệ trước khi cập nhật formData
