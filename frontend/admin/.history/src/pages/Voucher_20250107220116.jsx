...
const Voucher = () => {
  ...
  useEffect(() => {
    // Tạo 12 voucher mẫu
    const sampleVouchers = Array.from({ length: 12 }, (_, index) => ({
      voucher_id: `v${(index + 1).toString().padStart(5, "0")}`,
      code: `CODE${index + 1}`,
      start_date: "2024-01-01T00:00",
      end_date: "2024-12-31T23:59",
      discount_percentage: index % 2 === 0 ? (index + 1) * 5 : null,
      discount_amount: index % 2 !== 0 ? (index + 1) * 10000 : null,
      minimum_order_amount: index * 50000,
