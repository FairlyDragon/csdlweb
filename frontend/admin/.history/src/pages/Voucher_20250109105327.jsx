...
const Voucher = () => {
  ...
  useEffect(() => {
    ...
    // Nếu không có dữ liệu trong localStorage, sử dụng sampleVouchers
    if (!storedVouchers) {
  ...
  const handleAddVoucher = (newVoucher) => {
    if (newVoucher) {
      ...
      const updatedVouchers = [voucherWithId, ...vouchers];
