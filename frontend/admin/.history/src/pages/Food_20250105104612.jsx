        ...
        {categories.map((category) => (
          <Card
            ...
            sx={{
              ...
              p: 2,
              cursor: 'pointer',
              bgcolor: selectedCategory === category.id ? '#FFF3E0' : 'white',
              border: selectedCategory === category.id ? '1px solid #FF5722' : '1px solid #F4F6F8',
              borderRadius: 2,
