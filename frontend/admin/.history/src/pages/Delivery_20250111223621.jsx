      ...
      <Grid container spacing={3} sx={{ mb: 3 }}>
        <Grid item xs={4}>
          <Card sx={{ p: 2, display: 'flex', alignItems: 'center', gap: 2 }}>
            <LocalShippingOutlinedIcon sx={{ fontSize: 40, color: '#1890FF' }} />
            <Box>
        ...
        <Grid item xs={4}>
          <Card sx={{ p: 2, display: 'flex', alignItems: 'center', gap: 2 }}>
            <PendingActionsOutlinedIcon sx={{ fontSize: 40, color: '#FFAB00' }} />
            <Box>
            ...
            <List>
              {waitingShippers.map((shipper) => (
                <ListItem
                  ...
                  sx={{ bgcolor: 'white', color: 'black', mb: 1, borderRadius: '4px' }}
                >
                  <ListItemText
