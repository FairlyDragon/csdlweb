...
#     # status_code: int
#     status_description: DeliveryStatusEnum # preparing, delivering, delivered
...
#     ## the initial status of 'OrderDelivery.delivery_status.status_description' is 'preparing'
