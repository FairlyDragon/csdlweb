...
export default function Food() {
  ...
  const handleAddProduct = (newProduct) => {
    foodService.createFood(newProduct)
      .then(response => {
    ...
    foodService.updateFood(editedProduct.menuitem_id, editedProduct)
      .then(() => {
        setProducts(products.map(product =>
          product.menuitem_id === editedProduct.menuitem_id ? editedProduct : product
        ));
  ...
  const handleDeleteProduct = (productId) => {
    foodService.deleteFood(productId)
      .then(() => {
        setProducts(products.filter(product => product.menuitem_id !== productId));
        setEditDialog({ open: false, product: null });
      });
  };
