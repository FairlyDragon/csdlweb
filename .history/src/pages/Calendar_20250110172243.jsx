  ...
  const DayColumn = ({ day, events }) => (
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Typography sx={{
          color: format(day, 'eee') === 'Sun' || 
                 format(day, 'eee') === 'Sat' ? '#FF4842' : '#637381',
          fontSize: '0.875rem',
          mb: 1
        }}>
          {format(day, 'EEE')}
        ...
        <Box sx={{
          ...
          <Typography sx={{
            fontSize: '1.5rem',
            fontWeight: 500,
            color: isSameDay(day, new Date()) ? '#fff' :
                   isSameDay(day, selectedDate) ? '#1a73e8' :
                   format(day, 'eee') === 'Sun' || 
                   format(day, 'eee') === 'Sat' ? '#FF4842' : '#333'
          }}>
            {format(day, 'd')}
          </Typography>
        </Box>
      ...
      {events.map(event => {
        if (isSameDay(day, event.start)) {
          const top = (event.start.getHours() - 1) * 48 + 
