        ...
        <Table>
          <TableHead>
            <TableRow sx={{ backgroundColor: "#F4F6F8" }}>
              ...
              <TableCell sx={{ color: "#637381", fontWeight: 600 }}>CREATED AT</TableCell>
              <TableCell sx={{ color: "#637381", fontWeight: 600 }}>ACCOUNT</TableCell>
              <TableCell sx={{ color: "#637381", fontWeight: 600 }}>GENDER</TableCell>
              <TableCell sx={{ color: "#637381", fontWeight: 600 }}>AGE</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {/* ... TableBody giống Customer.jsx */}
          </TableBody>
        </Table>
        <TablePagination
          component="div"
