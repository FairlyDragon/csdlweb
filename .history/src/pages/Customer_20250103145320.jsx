...
const initialCustomers = [
  ...
  },
  {
    ...
    date_of_birth: new Date("1992-08-21").toISOString(),
  },
  {
    customer_id: "00003",
    name: "Nguyen Van C",
    ...
    date_of_birth: new Date("1988-12-03").toISOString(),
  },
  {
    customer_id: "00004",
    name: "Nguyen Van D",
    ...
    date_of_birth: new Date("1995-03-30").toISOString(),
  },
  {
    customer_id: "00005",
    name: "Nguyen Van E",
    email: "customer5@gmail.com",
    password: "hashed5password",
    phone_number: "0123466789",
    address: "123 Nguyen Hi",
    gender: "Male",
    created_at: new Date("2024-02-04").toISOString(),
    date_of_birth: new Date("1991-07-12").toISOString(),
  },
  {
    customer_id: "00006",
    name: "Nguyen Van F",
    email: "customer6@gmail.com",
    password: "hashed6password",
    phone_number: "0143456789",
    address: "12 Nguyen Trai",
    gender: "Female",
    created_at: new Date("2024-01-02").toISOString(),
    date_of_birth: new Date("1993-11-25").toISOString(),
  },
  {
    customer_id: "00007",
    name: "Nguyen Van G",
    email: "customer7@gmail.com",
    password: "hashed7password",
    phone_number: "0123459789",
    address: "13 Nguyen Trai",
    gender: "Male",
    created_at: new Date("2024-03-06").toISOString(),
    date_of_birth: new Date("1987-09-18").toISOString(),
  },
