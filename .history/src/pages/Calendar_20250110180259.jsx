...
const Calendar = () => {
  ...
  // Form component cho event
  const EventForm = () => (
    <Dialog open={isEventFormOpen} onClose={() => setEventFormOpen(false)}>
      <Box sx={{ p: 3, width: '400px' }}>
        <Typography variant="h6" sx={{ mb: 2 }}>Add Event</Typography>
        <TextField
          fullWidth
          label="Title"
        ...
        <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 1 }}>
          ...
          <Button variant="contained" onClick={handleEventSubmit}>Save</Button>
        </Box>
      </Box>
    </Dialog>
  );
