...
export default function Shipper() {
  ...
  useEffect(() => {
    ...
    if (statusFilter !== "all") {
      result = result.filter(
        (shipper) => shipper.account_status.toLowerCase() === statusFilter.toLowerCase()
      );
    }

    setFilteredShippers(result);
  }, [shippers, dateSort, amountSort, genderFilter, searchQuery, searchType, statusFilter]);
                ...
                <TableCell align="center">
                  <Box
                    sx={{
                      ...
                      bgcolor: shipper.account_status === 'active' ? '#E8FFF3' : '#FFE7D9',
                      color: shipper.account_status === 'active' ? '#00B69B' : '#B72136',
                      px: 2,
                      py: 0.5,
                      borderRadius: 1,
                      fontSize: '0.75rem',
