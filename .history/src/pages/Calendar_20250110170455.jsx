    ...
    return (
      <Box sx={{ 
        ...
        {months.map((days, monthIndex) => (
          <Box key={monthIndex} sx={{ minHeight: '220px' }}>
            <Typography 
              sx={{ 
                mb: 1, 
                color: '#637381',
                ...
                >
                  <Box
                    sx={{
                      ...
                      cursor: 'pointer',
                      '&:hover': {
                        bgcolor: !isSameDay(day, new Date()) ? 'rgba(0,0,0,0.04)' : '#1a73e8'
                      }
                    }}
                  >
                    <Typography
                      sx={{
                        ...
                        color: isSameDay(day, new Date()) ? 'white' :
                               isSameDay(day, selectedDate) ? '#1a73e8' :
                               !isSameMonth(day, new Date(selectedDate.getFullYear(), monthIndex)) ? '#bbb' :
                               i % 7 === 0 || i % 7 === 6 ? 'red' : 'inherit',
                      }}
                    >
                      {format(day, 'd')}
                    </Typography>
