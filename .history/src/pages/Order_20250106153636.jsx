...
const sampleOrders = [
  // Các đơn hàng đang chờ xử lý (waiting)
  {
    ...
    voucher_id: null,
    discount_applied: 0,
    // Thông tin từ bảng Customer thông qua customer_id
    customer: {
      customer_id: 2,
      name: "Ho Thi B",
      address: "20 Tay Son",
    ...
    // Thông tin từ bảng OrderDetails thông qua order_id
    order_details: [
      {
        order_details_id: 1,
        order_id: "00002",
    ...
    // Thông tin từ bảng Payment thông qua order_id
    payment: {
      payment_id: 1,
      order_id: "00002",
    ...
    // Thông tin từ bảng OrderDelivery thông qua order_id
    delivery: {
      delivery_id: 1,
      order_id: "00002",
      shipper_id: null,
