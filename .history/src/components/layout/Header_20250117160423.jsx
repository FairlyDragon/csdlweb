...
export default function Header() {
  ...
  useEffect(() => {
    const fetchAllCounts = async () => {
      try {
        // Fetch food count
        const foodResponse = await fetch("http://127.0.0.1:8000/admin/foods/menuitems/", {
          headers: {
        ...
        const deliveringResponse = await fetch("http://127.0.0.1:8000/admin/deliveries/delivering_orders", {
          headers: {
            accept: "application/json",
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
        ...
        const expiredResponse = await fetch("http://127.0.0.1:8000/admin/vouchers/expired", {
          headers: {
            accept: "application/json",
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
        ...
        const waitingResponse = await fetch("http://127.0.0.1:8000/admin/deliveries/num_of_waiting_orders", {
          headers: {
            accept: "application/json",
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
