...
export default function Header() {
  ...
  const [availableVoucherCount, setAvailableVoucherCount] = useState(0);
  ...
  useEffect(() => {
    ...
    const interval = setInterval(fetchAllCounts, 30000); // 30000ms = 30 giây
      ...
      <Box sx={{ display: "flex", alignItems: "center" }}>
        <Box sx={{ display: "flex", alignItems: "center", gap: 2.5 }}>
          ...
          <IconContainer $variant="gift">
            <StyledBadge badgeContent={availableVoucherCount} $variant="gift">
