      ...
      <Box sx={{ display: "flex", alignItems: "center" }}>
        <Box sx={{ display: "flex", alignItems: "center", gap: 1.5 }}>
          <IconContainer $variant="notification">
            <StyledBadge variant="standard" badgeContent={2} color="primary">
              <NotificationsNoneIcon />
            </StyledBadge>
          </IconContainer>

          <IconContainer $variant="email">
            <StyledBadge variant="standard" badgeContent={3} color="primary">
              <EmailOutlinedIcon />
            </StyledBadge>
          </IconContainer>

          <IconContainer $variant="cart">
            <StyledBadge variant="standard" badgeContent={5} color="primary">
              <ShoppingCartOutlinedIcon />
            </StyledBadge>
          </IconContainer>

          <IconContainer $variant="settings">
            <StyledBadge variant="standard" badgeContent={19} color="primary">
