  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ display: "flex", gap: 2, mb: 3 }}>
        <Card sx={{ flex: 2, p: 3, bgcolor: "white" }}>
        ...
        <Card sx={{ flex: 1, p: 3, bgcolor: "white" }}>
      ...
      <Box sx={{ display: "flex", gap: 2 }}>
        <Card sx={{ flex: 2, p: 3, bgcolor: 'white' }}>
          {orderDetails.orderItems.map((item) => (
            ...
            >
              <Box sx={{ display: "flex", flex: 1, maxWidth: '60%' }}>
                <img
                  src={item.food.image}
                  alt={item.food.name}
                  style={{
              ...
              <Typography sx={{ color: "#212B36", minWidth: '120px', textAlign: 'right' }}>
