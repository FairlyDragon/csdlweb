    ...
    >
              ...
              {orderDetails?.order_details?.map((item, index) => (
                ...
                >
                  ...
                  <Typography color="text.secondary">
                    +$
                    {((item.quantity || 0) * (item.subtotal || 0)).toFixed(2)}
                  </Typography>
                </Box>
              ))}
      ...
      <DialogActions sx={{ p: 3, borderTop: "1px solid #DFE3E8" }}>
        ...
        <Button
          ...
          sx={{
            minWidth: 120,
            bgcolor: "#FF4842", // Red color
            color: "white",
            "&:hover": {
              bgcolor: "#B72136", // Darker red on hover
            },
            mr: 1,
          }}
        >
        ...
        <Button
          ...
          sx={{
            minWidth: 120,
            bgcolor: "#00AB55", // Green color
            color: "white",
            "&:hover": {
              bgcolor: "#007B55", // Darker green on hover
            },
          }}
        >
          Accept
