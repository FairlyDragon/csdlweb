        ...
        <Box sx={{ display: "grid", gap: 3 }}>
            ...
            <Box>
              ...
              <Typography sx={{ color: "#212B36" }}>
                {shipperDetails?.date_of_birth
                  ? format(new Date(shipperDetails.date_of_birth), "MM/dd/yyyy")
                  : "N/A"}
              </Typography>
            </Box>
          </Box>
          ...
          <Box sx={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 3 }}>
            <Box>
              ...
              <Typography sx={{ color: "#212B36" }}>
                {calculateAge(shipperDetails?.date_of_birth)} years old
              </Typography>
            </Box>
            ...
            <Box>
              ...
              <Typography sx={{ color: "#212B36" }}>
                {format(new Date(shipperDetails?.created_at), "MM/dd/yyyy")}
              </Typography>
            </Box>
          </Box>
