  ...
  const fetchStats = useCallback(async (dateRange = null) => {
    try {
      let response;
      if (dateRange) {
      ...
      setStats([
        {
          ...
          change: `${response.total_orders.growth_rate > 0 ? "+" : ""}${
            response.total_orders.growth_rate
          }%`,
          icon: ShoppingBag,
          color: "#10B981",
          iconBg: "#E8F8F5",
        ...
        },
        {
          ...
          change: `${response.total_delivered.growth_rate > 0 ? "+" : ""}${
            response.total_delivered.growth_rate
          }%`,
          icon: LocalShipping,
          color: "#10B981",
          iconBg: "#E8F8F5",
        ...
        },
        {
          ...
          change: `${response.total_canceled.growth_rate > 0 ? "+" : ""}${
            response.total_canceled.growth_rate
          }%`,
          icon: Cancel,
          color: "#FF4842",
          iconBg: "#FFF5F5",
        ...
        },
        {
          ...
          change: `${response.total_revenue.growth_rate > 0 ? "+" : ""}${
            response.total_revenue.growth_rate
          }%`,
          icon: AttachMoney,
          color: "#10B981",
          iconBg: "#E8F8F5",
