      ...
      <Box>
        ...
        <Box sx={{ 
          ...
          <Paper sx={{ 
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
              ...
              <Typography color="text.secondary">Total Purchase</Typography>
            </Box>
            <Typography variant="h3" sx={{ fontWeight: 500 }}>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mb: 3 }}>
          <Button
            variant="outlined"
            startIcon={
              <Box component="span" sx={{ color: '#4dabf7' }}>⬇️</Box>
            }
            sx={{ 
              color: '#4dabf7',
              borderColor: '#4dabf7',
        ...
        <TableContainer>
          <Table>
            <TableHead>
              <TableRow>
                <TableCell sx={{ color: '#495057', fontWeight: 500 }}>ID</TableCell>
                <TableCell sx={{ color: '#495057', fontWeight: 500 }}>NAME</TableCell>
                <TableCell sx={{ color: '#495057', fontWeight: 500 }}>ADDRESS</TableCell>
                <TableCell sx={{ color: '#495057', fontWeight: 500 }}>DATE</TableCell>
                <TableCell sx={{ color: '#495057', fontWeight: 500 }}>Food</TableCell>
                <TableCell sx={{ color: '#495057', fontWeight: 500 }}>Payment</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
