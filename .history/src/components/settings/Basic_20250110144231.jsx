...
const Basic = ({ isActive, setIsActive }) => {
  ...
  return (
    <Box sx={{ maxWidth: 800, p: 3, bgcolor: 'white', borderRadius: 2, boxShadow: '0 0 2px 0 rgba(145, 158, 171, 0.2), 0 12px 24px -4px rgba(145, 158, 171, 0.12)' }}>
      {/* Header Section */}
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
        <Typography variant="h6" sx={{ color: '#212B36', fontWeight: 600 }}>
          Basic Information
        </Typography>
        <Button
          startIcon={<EditIcon />}
      ...
      <Box sx={{ display: 'grid', gap: 3 }}>
        ...
        <Box sx={{ 
          ...
          <Typography sx={{ color: '#637381', fontWeight: 500 }}>Address</Typography>
          <Typography sx={{ color: '#212B36' }}>{formData.address}</Typography>
        ...
        {[
          ...
          >
            <Typography sx={{ color: '#637381', fontWeight: 500 }}>{field.label}</Typography>
            <Typography sx={{ color: '#212B36' }}>{field.value}</Typography>
          </Box>
        ))}
        ...
        <Box sx={{
          ...
          <Typography sx={{ color: '#637381', fontWeight: 500 }}>QR Code</Typography>
          <Box
            sx={{
              width: 120,
              height: 120,
        ...
        <Box sx={{
          ...
          <Typography sx={{ color: '#637381', fontWeight: 500 }}>Privacy Policy</Typography>
          <Typography 
            sx={{ 
              color: '#212B36',
              whiteSpace: 'pre-wrap',
