...
export const foodService = {
  ...
  async updateFood(menuitem_id, foodData) {
    ...
    console.log("Updating food with ID:", menuitem_id); // Debug log
    try {
  ...
  async deleteFood(menuitem_id) {
    ...
    console.log("Deleting food with ID:", menuitem_id); // Debug log
    try {
      const response = await axiosInstance.delete(`/menuitems/${menuitem_id}`);
      return response.data;
    } catch (error) {
  ...
  async updateDiscount(discount_percentage) {
    try {
      const response = await axiosInstance.put(`/discount/${discount_percentage}`);
      return response.data;
    } catch (error) {
