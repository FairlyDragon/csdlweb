...
async def dashboard_header( time_period: TimePeriod = Depends(get_time_period), current_user: UserSchema = Depends(get_current_user)):
...
@role_required(any_admin_roles)
async def dashboard_center_total_orders( periodicity: str = "daily", current_user: UserSchema = Depends(get_current_user)):
...
@role_required(any_admin_roles)
async def dashboard_center_total_revenue( periodicity: str = "daily", current_user: UserSchema = Depends(get_current_user)):
...
@role_required(any_admin_roles)
async def dashboard_center_customers_map( periodicity: str = "daily", current_user: UserSchema = Depends(get_current_user)):
...
@role_required(any_admin_roles)
async def dashboard_footer( skip: int = 0, limit: int = 5, current_user: UserSchema = Depends(get_current_user)):
...
@role_required(any_admin_roles)
async def assign_delivery_route(order_id: str, shipper_id: str, current_user: UserSchema = Depends(get_current_user)):
...
@role_required(any_admin_roles)
async def update_order_route(order_id: str, status: str = Path(..., example="processing"), current_user: UserSchema = Depends(get_current_user)):
...
@role_required(any_admin_roles)
async def get_customer_report_route(time_period: TimePeriod = Depends(get_time_period), current_user: UserSchema = Depends(get_current_user)):
...
@role_required(any_admin_roles)
async def get_shipper_report_route(time_period: TimePeriod = Depends(get_time_period), current_user: UserSchema = Depends(get_current_user)):
...
@role_required(any_admin_roles) 
async def get_restaurant_report_route(time_period: TimePeriod = Depends(get_time_period), current_user: UserSchema = Depends(get_current_user)):
